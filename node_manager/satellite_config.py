...
class Config:
    ...
    def __init__(self, filepath: str):
        ...
        # hs add
        if parser.has_option("Docker","GroundConfigPath_APP"):
            self.GroundConfigPath_APP = parser["Docker"]["GroundConfigPath_APP"]
        if parser.has_option("Docker", "UserImageName"):
            self.UserImageName = parser["Docker"]["UserImageName"]